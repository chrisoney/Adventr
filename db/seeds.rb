...
temp_quest_1 = Quest.new(title: "Test quest 1", text: "text body", quest_type: "text", user_id: hero.id)
temp_quest_2 = Quest.new(title: "Test quest 2", text: "text body", quest_type: "text", user_id: hero.id)

[temp_quest_1, temp_quest_2].each do |quest|
  quest.save
end
