...
goblin_hordes = Tag.create(tag_name: 'goblin hordes')
...
magic_staffs = Tag.create(tag_name: 'magic staffs')
magic_swords = Tag.create(tag_name: 'magic swords')
magic_wands = Tag.create(tag_name: 'magic wands')
...
sorcerers = Tag.create(tag_name: 'sorcerers')
sorcerers = Tag.create(tag_name: 'sorcerers')
# tags = ["sorcery","spell components","spellbooks","spys","squire","staffs","steel rank","swords","teleport","tieflings","tomes","transmutation","trolls","uncommon","undead","unseelie court","vampires","warlocks","warriors","water","wilderness","wind","wizards","wurms"]
# for tag in tags
