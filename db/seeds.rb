...
# # Jess quest 27 - Video
# jess_quest_27 = Quest.new(title: "The benefits of high DEX", text: "STR is important too, but I cannot express emphatically enough how easily a decent DEX could save your hide. This is just an example of the mobility a solid DEX stat can give you, even in rough terrain.", quest_type: "video", user_id: jess.id)

# # Jess quest 28 - Audio
# jess_quest_28 = Quest.new(title: "Our team's anthem", text: "", quest_type: "audio", user_id: jess.id)

# # Ingrid quests
# # Ingrid quest 29 - Text
# ingrid_quest_29 = Quest.new(title: "Looking for talented craftswomen and craftsmen to build equipment based around the scales of an adult white dragon.", text: "Payment can be negotiated, but will based around normal currency and materials remaining after the jobs are done. Please only inquire if you are skilled enough to have worked with materials from platinum ranks threats or above.", quest_type: "text", user_id: ingrid.id)

# # Ingrid quest 30 - Image
# ingrid_quest_30 = Quest.new(title: "Looking for information on local dire wolf populations", text: "Half payment up front, the other half after your intel is confirmed. Looking for any and all information, especially locations and warnings about any aberrant behavior.", quest_type: "image", user_id: ingrid.id)

# # Ingrid quest 31 - Image
# ingrid_quest_31 = Quest.new(title: "Request mage support with the exploration of a potentially new dungeon in the Brennan range.", text: "Exact details will be discussed during negotiations. We hold claim over first delve for over 3 weeks due to guild law. We seek those with powerful fire magic.", quest_type: "image", user_id: ingrid.id)

# # Ingrid quest 32 - Image
# ingrid_quest_32 = Quest.new(title: "Don't know what the hells this is supposed to be but it's out there.", text: "Any information would be useful, though we don't intend on hunting it down. We almost lost 3 of our own. It used purely physical attacks to chase us off, though that doesn't rule out it knowing magic. Couldn't [Appraise] it, which is why we don't have a name. It seems DEX focused.", quest_type: "image", user_id: ingrid.id)

# # Ingrid quest 33 - Quote
# ingrid_quest_33 = Quest.new(title: "In preparing for battle I have always found that plans are useless, but planning is indispensable.", text: "Dwight D. Eisenhower", quest_type: "quote", user_id: ingrid.id)

# # Ingrid quest 34 - Video
# ingrid_quest_34 = Quest.new(title: "Footage from a scrying orb of an old battle my kingdom was involved in", text: "It was a great day for my people. A resounding win. Enjoy and take note of our power", quest_type: "video", user_id: ingrid.id)

# # Ingrid quest 35 - Audio
# ingrid_quest_35 = Quest.new(title: "Battle music is integral to success", text: "We often hire a bard for the greatest battles we partake in", quest_type: "audio", user_id: ingrid.id)

# # Kmsvr quests
# # Kmsvr quest 36 - Text
# kmsvr_quest_36 = Quest.new(title: "Have you read The Wandering Inn?", text: "It is a very long story, but it's a good story. It also has several wonderful characters like me (Kmsvr). Please go give it a chance, it is one of my (Kmsvr's) favorites.", quest_type: "text", user_id: kmsvr.id)
...
# --------------------------------Quests End-----------------------------------
# -------------------------------Find Quests-----------------------------------
ingrid_quest_33 = Quest.find(1)
rain_quest_55 = Quest.find(2)
goblin_slayer_quest_45 = Quest.find(3)
hero_quest_7 = Quest.find(4)
matt_quest_18 = Quest.find(5)
matt_quest_17 = Quest.find(6)
goblin_slayer_quest_49 = Quest.find(7)
ingrid_quest_32 = Quest.find(8)
rain_quest_52 = Quest.find(9)
ingrid_quest_34 = Quest.find(10)
jess_quest_25 = Quest.find(11)
terriblis_quest_9 = Quest.find(12)
rain_quest_54 = Quest.find(13)
hero_quest_3 = Quest.find(14)
kmsvr_quest_36 = Quest.find(15)
carl_quest_61 = Quest.find(16)
rain_quest_50 = Quest.find(17)
carl_quest_59 = Quest.find(18)
terriblis_quest_8 = Quest.find(19)
kmsvr_quest_39 = Quest.find(20)
rain_quest_53 = Quest.find(21)
hero_quest_6 = Quest.find(22)
kmsvr_quest_41 = Quest.find(23)
catherine_quest_68 = Quest.find(24)
kmsvr_quest_38 = Quest.find(25)
matt_quest_16 = Quest.find(26)
carl_quest_60 = Quest.find(27)
ingrid_quest_35 = Quest.find(28)
kmsvr_quest_40 = Quest.find(29)
catherine_quest_67 = Quest.find(30)
goblin_slayer_quest_44 = Quest.find(31)
jess_quest_24 = Quest.find(32)
jess_quest_26 = Quest.find(33)
hero_quest_1 = Quest.find(34)
goblin_slayer_quest_43 = Quest.find(35)
hero_quest_4 = Quest.find(36)
kmsvr_quest_37 = Quest.find(37)
ingrid_quest_29 = Quest.find(38)
goblin_slayer_quest_47 = Quest.find(39)
carl_quest_62 = Quest.find(40)
matt_quest_15 = Quest.find(41)
catherine_quest_66 = Quest.find(42)
jess_quest_22 = Quest.find(43)
terriblis_quest_11 = Quest.find(44)
carl_quest_63 = Quest.find(45)
hero_quest_2 = Quest.find(46)
terriblis_quest_10 = Quest.find(47)
catherine_quest_69 = Quest.find(48)
catherine_quest_64 = Quest.find(49)
rain_quest_56 = Quest.find(50)
goblin_slayer_quest_46 = Quest.find(51)
matt_quest_21 = Quest.find(52)
rain_quest_51 = Quest.find(53)
terriblis_quest_13 = Quest.find(54)
jess_quest_28 = Quest.find(55)
ingrid_quest_31 = Quest.find(56)
catherine_quest_70 = Quest.find(57)
jess_quest_27 = Quest.find(58)
matt_quest_20 = Quest.find(59)
kmsvr_quest_42 = Quest.find(60)
matt_quest_19 = Quest.find(61)
terriblis_quest_14 = Quest.find(62)
terriblis_quest_12 = Quest.find(63)
catherine_quest_65 = Quest.find(64)
jess_quest_23 = Quest.find(65)
hero_quest_5 = Quest.find(66)
carl_quest_58 = Quest.find(67)
carl_quest_57 = Quest.find(68)
goblin_slayer_quest_48 = Quest.find(69)
ingrid_quest_30 = Quest.find(70)
# ------------------------------Find Quests End--------------------------------

# # Reblogs Section
# # Hero Reblog 1
# hero_reblog_1 = Reblog.new(user_id: hero.id, quest: terriblis_quest_11, text: "Is there any way to veto another person's quest? Or cancel it? I suspect the completition of this won't work out well for me...")

# # Hero Reblog 2
# hero_reblog_2 = Reblog.new(user_id: hero.id, quest: catherine_quest_67, text: "I'm told you accept heroes alongside villains? I'm not sure how much help I can be of, but I'll lend my sword.")

# # Hero Reblog 3
# hero_reblog_3 = Reblog.new(user_id: hero.id, quest: rain_quest_55, text: "Absolutely classic. How did you get a copy over here? Wait, are you even from... y'know... The other place?")

# # Terriblis Reblog 4
# terriblis_reblog_4 = Reblog.new(user_id: terriblis.id, quest: goblin_slayer_quest_46, text: "No. No, that is not a goblin. Is this a real question?")

# # Terriblis Reblog 5
# terriblis_reblog_5 = Reblog.new(user_id: terriblis.id, quest: kmsvr_quest_40, text: "Stop quoting yourself. What is wrong with the adventurers here?")

# # Terriblis Reblog 6
# terriblis_reblog_6 = Reblog.new(user_id: terriblis.id, quest: matt_quest_18, text: "I would be interested in writing guest articles for your publication. If you consider the expertise of an ancient being that has seen the rise and fall of more civilizations than you can name sufficient, I shall await your correspondence.")

# # Matt Reblog 7
# matt_reblog_7 = Reblog.new(user_id: matt.id, quest: hero_quest_1, text: "Have you any interest in magic? Stories say that Heroes level quite a bit more quickly than your average adventurer. Our team of coaches can ensure that you achieve the most powerful spellcasting build possible in the most efficient way possible. Please don't hesitate to stop by one of our offices for a consultation!")

# # Matt Reblog 8
# matt_reblog_8 = Reblog.new(user_id: matt.id, quest: terriblis_quest_8, text: "Having trouble with security? Our expert team of [Inscribers] can set up runic defense arrays in any environment. Stop by one of our offices for a consultation and preliminary quote!")

# # Matt Reblog 9
# matt_reblog_9 = Reblog.new(user_id: matt.id, quest: goblin_slayer_quest_45, text: "Looking for the latest and/or greatest in spellcasting scrolls for any occasion? Look no further! We have scrolls you've never dreamed of! Offensive spells, defensive arrays, utility magic, we've got it all! Grab one of our catalogues from the front desk of any Adventurer's Guild and you won't be disappointed!")

# # Jess Reblog 10
# jess_reblog_10 = Reblog.new(user_id: jess.id, quest: matt_quest_16, text: "I would like to schedule an appointment. Will give more details about the loot in person, but it consists of mostly silver-grade weaponry and a gold-rank helm.")

# # Jess Reblog 11
# jess_reblog_11 = Reblog.new(user_id: jess.id, quest: carl_quest_63, text: "We are interested in these traps you make. I have heard tell that there is little magic to them. We have an alchemist who would love to discuss things with you, to the benefit of both.")

# # Jess Reblog 12
# jess_reblog_12 = Reblog.new(user_id: jess.id, quest: ingrid_quest_33, text: "Spoken like a true leader. Best of luck in your adventures.")

# # Ingrid Reblog 13
# ingrid_reblog_13 = Reblog.new(user_id: ingrid.id, quest: catherine_quest_68, text: "My team will answer your call, Queen Catherine, as our ancestors have done for yours.")

# # Ingrid Reblog 14
# ingrid_reblog_14 = Reblog.new(user_id: ingrid.id, quest: carl_quest_60, text: "Where might this \"Iron Tangle\" be located? It looks to be a challenge, and The Court of Winter seeks to sharpen our skills.")

# # Ingrid Reblog 15
# ingrid_reblog_15 = Reblog.new(user_id: ingrid.id, quest: goblin_slayer_quest_44, text: "Water Town is but a day's ride from our location. We shall aide you in this.")

# # Kmsvr Reblog 16
# kmsvr_reblog_16 = Reblog.new(user_id: kmsvr.id, quest: catherine_quest_66, text: "I think you may be underestimating the evil incarnate in water, Your Grace.")

# # Kmsvr Reblog 17
# kmsvr_reblog_17 = Reblog.new(user_id: kmsvr.id, quest: carl_quest_59, text: "Goblins are our friends, except when they are not. When they are not, are they succeptible to ambushing tactics? Asking for a friend also named Kmsvr. Please don't tell Erin.")

# # Kmsvr Reblog 18
# kmsvr_reblog_18 = Reblog.new(user_id: kmsvr.id, quest: rain_quest_56, text: "Are these song crystals for sale? I think this would be good music to play during ambushes. It would frighten bandits and maybe animals. Maybe not animals. We will need to test.")

# # Goblin Slayer Reblog 19
# goblin_slayer_reblog_19 = Reblog.new(user_id: goblin_slayer.id, quest: jess_quest_22, text: "I will not join your team, as I have a team. You mentioned goblins. Tell me about the goblins.")

# # Goblin Slayer Reblog 20
# goblin_slayer_reblog_20 = Reblog.new(user_id: goblin_slayer.id, quest: jess_quest_23, text: "I will go there immediately.")

# # Goblin Slayer Reblog 21
# goblin_slayer_reblog_21 = Reblog.new(user_id: goblin_slayer.id, quest: kmsvr_quest_36, text: "This is pro-goblin propaganda. They told me it didn't exist but I was right.")

# # Rain Reblog 22
# rain_reblog_22 = Reblog.new(user_id: rain.id, quest: carl_quest_57, text: "I've had some really weird interactions, though I'm not sure we're talking about the same system, which is quite interesting in itself. Do you think we're in alternate timelines. Maybe dimensions? There's a difference. Let's start with simularities. Have you ever met someone with an injured soul? How does leveling work for you? Is there a cap? Do you know what \"blues\" are? I have more questions, but I'll hold onto them for now.")

# # Rain Reblog 23
# rain_reblog_23 = Reblog.new(user_id: rain.id, quest: goblin_slayer_quest_48, text: "Is this a normal way to team up in real life? It seems very Dungeons and Dragons.")

# # Rain Reblog 24
# rain_reblog_24 = Reblog.new(user_id: rain.id, quest: carl_quest_62, text: "I have no idea why someone would want to do a catshow of all things but now I can't get the idea out of my head. This is hilarious, I have to try it.")

# # Carl Reblog 25
# carl_reblog_25 = Reblog.new(user_id: carl.id, quest: hero_quest_2, text: "The AI likes to mess with us sometimes, especially if nobody's paying to push you into the quest. I once found a letter inside of the corpse of a ogre waiter. Apparently someone asked him to 'pass a note' and he took it to mean... well you get it. The logical leaps that NPCs make is a goddamn mystery in itself.")

# # Carl Reblog 26
# carl_reblog_26 = Reblog.new(user_id: carl.id, quest: jess_quest_25, text: "I'd like to purchase some for testing purposes. I'd also like samples of any other aberrant materials you have.")

# # Carl Reblog 27
# carl_reblog_27 = Reblog.new(user_id: carl.id, quest: terriblis_quest_9, text: "Carl: My teammate Donut would be interested in that training. Let's meet up on the next floor and hash out a deal.\nDonut: WHAT'S CRYSTAL WASH? THAT SOUNDS LOVELY CARL, I WANT THAT.")

# # Catherine Reblog 28
# catherine_reblog_28 = Reblog.new(user_id: catherine.id, quest: kmsvr_quest_37, text: "I'm afraid at first glance I cannot tell whether this is a team of Heroes or Villains, though it matters not. I call upon your aid against the Ancient Evil. If we must use a necromancer to defeat a necromancer... well, we've been party to worse.")

# # Catherine Reblog 29
# catherine_reblog_29 = Reblog.new(user_id: catherine.id, quest: goblin_slayer_quest_47, text: "Lovely words, though a bit frail should those actions not be supported by power.")

# # Catherine Reblog 30
# catherine_reblog_30 = Reblog.new(user_id: catherine.id, quest: ingrid_quest_33, text: "Could not have said it better myself, though I could add a bit more color to the language.")
...
#   reblog.save
# end
# Manually shuffled quests & reblogs

# combined_list = [ingrid_quest_33, rain_quest_55, catherine_reblog_30, goblin_slayer_quest_45, hero_reblog_3, jess_reblog_12, hero_quest_7, matt_quest_18, matt_reblog_9, matt_quest_17, goblin_slayer_quest_49, terriblis_reblog_6, ingrid_quest_32, rain_quest_52, ingrid_quest_34, jess_quest_25, terriblis_quest_9, rain_quest_54, carl_reblog_27, hero_quest_3, kmsvr_quest_36, carl_quest_61, rain_quest_50, carl_quest_59, terriblis_quest_8, kmsvr_quest_39, rain_quest_53, matt_reblog_8, kmsvr_reblog_17, hero_quest_6, kmsvr_quest_41, catherine_quest_68, kmsvr_quest_38, matt_quest_16, ingrid_reblog_13, carl_quest_60, ingrid_quest_35, kmsvr_quest_40, jess_reblog_10, ingrid_reblog_14, catherine_quest_67, terriblis_reblog_5, goblin_slayer_quest_44, jess_quest_24, hero_reblog_2, ingrid_reblog_15, jess_quest_26, hero_quest_1, goblin_slayer_quest_43, matt_reblog_7, hero_quest_4, kmsvr_quest_37, ingrid_quest_29, goblin_slayer_quest_47, catherine_reblog_28, carl_quest_62, catherine_reblog_29, matt_quest_15, catherine_quest_66, jess_quest_22, terriblis_quest_11, carl_quest_63, hero_quest_2, jess_reblog_11, goblin_slayer_reblog_19, terriblis_quest_10, hero_reblog_1, goblin_slayer_reblog_21, kmsvr_reblog_16, catherine_quest_69, catherine_quest_64, carl_reblog_26, rain_quest_56, goblin_slayer_quest_46, matt_quest_21, terriblis_reblog_4, rain_quest_51, terriblis_quest_13, kmsvr_reblog_18, jess_quest_28, ingrid_quest_31, catherine_quest_70, jess_quest_27, matt_quest_20, rain_reblog_24, kmsvr_quest_42, matt_quest_19, terriblis_quest_14, terriblis_quest_12, catherine_quest_65, jess_quest_23, hero_quest_5, carl_quest_58, goblin_slayer_reblog_20, carl_quest_57, goblin_slayer_quest_48, ingrid_quest_30, rain_reblog_22, carl_reblog_25, rain_reblog_23]
